      ...
      <aside className="row-start-3 col-start-1 bg-[#f3ecf9]">
        <div className="w-full h-[45vw] relative">
          <form onSubmit={handleSubmit} className="text-[#674771] flex px-[1.5vw] pb-[1vw] flex-col justify-around h-full">
            ...
            {/* pregunta titulo */}
            <div>
              <label htmlFor="title" className="text-[1.5vw] font-breeSerif tracking-wide">
                Título:
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="description" className="font-breeSerif text-[1.5vw]  tracking-wide">
                Descripción:
              </label>
              <textarea
                id="description"
            ...
            <div>
              <label htmlFor="phone" className="text-[1.5vw] font-breeSerif  tracking-wide">
                Contacto:
              </label>
              <input
                type="text"
            ...
            {/* pregunta precio */}
            <div>
              <label htmlFor="price" className="text-[1.5vw] font-breeSerif tracking-wide">
                Precio:
              </label>
              <input
                type="text"

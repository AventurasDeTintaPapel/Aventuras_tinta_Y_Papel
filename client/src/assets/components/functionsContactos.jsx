...
function P_infocontactos({textSpan,textInfo}){
  return <p className="font-medium list-item ml-[1.5vw] text-[1.2vw] text-purple-900"><span className="font-bold">{textSpan}</span>{textInfo}</p>
}
...
<div className="bg-gradient-to-r from-purple-300 to-purple-400 w-[40vw] flex flex-col gap-[2vw] px-[2vw] py-[2vw] h-auto text-[1.3vw] justify-evenly rounded-xl shadow-lg hover:shadow-xl">
 ...
 {/* info */}
  <p className="text-violet-900 text-center leading-relaxed">
    <span className="font-semibold">Si necesitas información</span> sobre cualquiera de nuestros productos o si estás teniendo algún inconveniente con la compra o con la página, rellena nuestro formulario y nos pondremos en contacto lo antes posible.
    <br />
  ...
  <div className="border-t border-purple-200 pt-[1.5vw] mt-[1.5vw]">
    ...
    <P_infocontactos textInfo={" info@aventuras.com.ar"} textSpan={"Email:"}/>
      ...
      <form className="flex flex-col gap-[1vw] font-bold bg-gradient-to-r shadow-lg from-purple-300 to-purple-400 w-[30vw] p-[1.5vw] rounded-xl text-violet-950">
        ...
        <div>
          <label htmlFor="mensaje" className="text-[1.2vw] ml-[0.5vw]">Mensaje:</label>
          <textarea
        ...
        <button
          type="submit"
          className="w-full bg-purple-800 text-fuchsia-200 text-[1.5vw] h-[4vw] rounded-md"
        >
          Enviar
        </button>
      </form>

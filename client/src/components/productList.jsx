  ...
  const handleSaveEdit = async () => {
    try {
      ...
      const updatedProducts = products.map(product => 
        product._id === editingProduct ? { ...product, ...productData, imagen: selectedFile ? URL.createObjectURL(selectedFile) : product.imagen } : product
      );
                ...
                {editingProduct === product._id ? (
                  ...
                  <div className="absolute inset-0 bg-white p-4 z-10 flex flex-col">
                    ...
                    <div className="flex justify-between mt-2">
                      <button onClick={handleSaveEdit} className="bg-blue-500 text-white p-2 rounded">Guardar</button>
                      <button onClick={() => setEditingProduct(null)} className="text-red-500">Cancelar</button>
                    </div>
                  </div>
                ) : (
                  ...
                  <div>
                    ...
                    <div className="px-6 pt-4 pb-2 flex justify-between items-center">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button onClick={() => handleDelete(product._id)} className="bg-red-500 text-white p-1 rounded">Eliminar</button>
                      </div>
                    </div>
                  </div>
                )}

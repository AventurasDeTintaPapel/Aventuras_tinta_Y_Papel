  ...
  function ProductosMenu() {
    ...
    return (
      <div className="relative">
        ...
        >
          <button className=" h-[3vw] flex ml-[1vw] items-center" onClick={() => handleTypeClick("libros")}>
            Libros
          </button>
          <button className=" h-[3vw] flex ml-[1vw] items-center" onClick={() => handleTypeClick("comics")}>
            Cómics
          </button>
          <button className=" h-[3vw] flex ml-[1vw] items-center" onClick={() => handleTypeClick("mangas")}>
            Mangas
          </button>
          <button className=" h-[3vw] flex ml-[1vw] items-center" onClick={() => handleTypeClick("mercancia")}>
            Mercancía
          </button>
        </div>
      </div>

...
function ProductosMenu() {
  ...
  return (
    <div className="relative">
      <button
        className={`flex gap-[0.5vw] justify-center items-center pt-[0.2vw] pb-[0.4vw] px-[0.5vw] 
      ...
      <div
        ...
        } transition ease-in-out duration-200 font-poopins absolute bg-purple-900 z-50 flex flex-col w-[15vw]`}
      >
        <Link to={"/productosAdmin"} className="text-[1.2vw] p-[0.5vw] hover:bg-[#5A189A] pl-[0.5vw]">
          Ver Productos
        </Link>
        <Link to={"/adminPanel"} className=" text-[1.2vw] p-[0.5vw] hover:bg-[#5A189A] pl-[0.5vw]">

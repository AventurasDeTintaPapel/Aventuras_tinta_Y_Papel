  ...
  return (
    <footer className="row-start-4  col-span-2">
      <div className="bg-purple-900 text-purple-100" style={{ fontFamily: "'Baloo 2', system-ui" }}>
        <div className="justify-center grid-cols-[20vw_1fr_5vw_1fr_10vw] grid-rows-2 grid space-y-[2vw] pb-[2vw]">
          {/* sobre nosotros */}
          <div className=" flex flex-col col-start-2 ml-[5vw] mt-[2vw]">
            <p className="text-[1.3vw] text-start font-semibold mb-[0.2vw]">Sobre Nosotros</p>
          ...
          {/* rutass rapidas */}
          <div className=" flex flex-col col-start-4 ml-[5vw]">
            <p className="text-[1.3vw] font-semibold mb-[0.2vw] ">Enlaces Rápidos</p>
            <div className="grid grid-cols-[9vw_9vw] gap-[0.5vw] ">
          ...
          {/* redes sociales */}
          <div className=" flex flex-col col-start-2 ml-[5vw]">

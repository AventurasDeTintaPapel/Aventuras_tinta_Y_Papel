  ...
  function IntercambioMenu() {
    ...
    return (
      <div className="relative">
        <button onClick={manejarClic} className="flex justify-center items-center gap-1 py-1 text-[10px]">
        ...
        <div
          ...
          } flex flex-col gap-2 py-1 absolute w-20 transition-all ease-linear duration-200 bg-purple-900 text-white text-[10px] z-50`}
        >
          <Link
            to={"/intercambiar"}
  ...
  return (
    <nav className={`${colAndrow} font-baloo`}>
      <div className="bg-[#3C096C] h-auto items-end flex justify-evenly text-white">
        <Link to={"/"} className="flex justify-center py-1  items-center  text-[10px]">
          <p>Inicio</p>
        </Link>
        <Link to={"/contactos"} className="flex py-1 justify-center items-center  text-[10px]">
          <p>Contactos</p>
        </Link>
        <Link to={"/catalogo"} className="flex py-1 justify-center items-center  text-[10px]">
          <p>Catalogo</p>
        </Link>
